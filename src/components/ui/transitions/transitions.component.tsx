import React, { forwardRef, CSSProperties, ExoticComponent, ReactElement, Ref } from 'react';
...
const Transitions = forwardRef(({ children, position, type, direction, ...others }: Props, ref: Ref<ExoticComponent>) => {
  let positionSX = {
